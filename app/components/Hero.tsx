...
export default function Hero() {
  return (
    ...
    >
      {/* Background Glow */}
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(234,179,8,0.15),transparent_60%)]"
        aria-hidden="true"
      />
      ...
      <div className="relative z-20 flex flex-col items-center">
        ...
        <div className="relative z-30 mt-10 flex flex-wrap justify-center gap-4">
          <a
            href="/location"
            className="pointer-events-auto rounded-full bg-yellow-400 px-8 py-3 font-bold text-black transition hover:scale-105 hover:bg-yellow-300"
          >
            Visit Khanqah
          </a>
          ...
          <a
            href="/about"
            className="pointer-events-auto rounded-full border border-yellow-400 px-8 py-3 font-bold text-yellow-300 transition hover:scale-105 hover:bg-yellow-400 hover:text-black"
          >
            Explore Darbar
          </a>
        </div>
